...
export default function InvoicePreview({ settings }: InvoicePreviewProps) {
  ...
  return (
    <div 
      className={`w-full overflow-hidden ${fontClass}`} 
    ...
    >
      ...
      <div className="p-6 text-center">
        ...
        <p className="text-xl">{branchName}</p>
      </div>
      ...
      <div className="p-6 text-center">
        <div className="flex justify-center items-center">
          <h2 className="text-4xl font-bold">SUM</h2>
          <span className="text-3xl ml-2">{currencySymbol}</span>
        </div>
      </div>
